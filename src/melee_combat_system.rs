use super::{CombatStats, Name, SufferDamage, WantsToMelee, gamelog::GameLog, MeleePowerBonus, DefenseBonus, Equipped};
use specs::prelude::*;
...
impl<'a> System<'a> for MeleeCombatSystem {
    ...
    fn run(&mut self, data: Self::SystemData) {
        let (entities, mut log, mut wants_melee, names, combat_stats, mut inflict_damage, melee_power_bonus, defense_bonus, equipped) = data;
